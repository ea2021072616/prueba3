...
<div id="layoutSidenav_content">
    ...
    <?php } ?>
    <main>
    <img src="https://res.cloudinary.com/icelandtours/g_auto,f_auto,c_auto,w_3840,q_auto:good/northern_lights_above_glacier_lagoon_v2osk_unsplash_7d39ca647f.jpg" alt="Banner Image" class="banner-image">
    <div class="dashboard">
    <!-- Contenido principal -->
